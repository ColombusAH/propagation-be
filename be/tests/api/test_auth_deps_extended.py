...
async def test_get_current_user_found():
    ...
    with patch("app.api.dependencies.auth.verify_access_token", return_value={"user_id": 1}), \
...
async def test_get_current_user_not_found():
    ...
    with patch("app.api.dependencies.auth.verify_access_token", return_value={"user_id": 999}), \
         patch("app.api.dependencies.auth.get_user_by_id", new_callable=AsyncMock) as mock_get:
