...
export function TagLinkingPage() {
    ...
    const handleLinkTags = () => {
        if (!selectedProduct || selectedTags.size === 0) return;
    ...
    const simulateTags = () => {
        const newTags: UnlinkedTag[] = Array.from({ length: 10 }, (_, i) => ({
            id: `tag-${Date.now()}-${i}`,
                ...
                <Grid>
                    ...
                    <Card>
                        ...
                        <div style={{ display: 'flex', gap: theme.spacing.sm, marginBottom: theme.spacing.md }}>
                            <SecondaryButton onClick={simulateTags}>
                                <span className="material-symbols-outlined">add</span>
                                סמלץ תגים
                            </SecondaryButton>
