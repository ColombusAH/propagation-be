...
def main():
    ...
    parser.add_argument("--ip", type=str, default=os.getenv("RFID_READER_IP", "169.254.247.1"),
                       help="Reader IP address")
    parser.add_argument("--ports", type=str, default="4001,5000,6000,8080,9090,2022,27011,10001,5678",
