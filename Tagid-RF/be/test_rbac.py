...
def main():
    ...
    results.append(("Public registration blocks admin roles", test_public_registration_with_admin_role()))
    ...
    if response.status_code == 201:
        ...
        print("\n\n### TEST 3: Customer Cannot Create Tag Mappings ###")
        results.append(("Customer blocked from creating tag mappings", test_customer_cannot_create_tag_mapping(customer_token)))
        
        # Test 4: Customer cannot delete tag mappings
        print("\n\n### TEST 4: Customer Cannot Delete Tag Mappings ###")
        results.append(("Customer blocked from deleting tag mappings", test_customer_cannot_delete_tag_mapping(customer_token)))
    else:
