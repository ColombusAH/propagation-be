...
class NotificationPreference(Base):
    ...
    # Channels
    channel_push = Column(Boolean, default=True, nullable=False, comment="Push notification enabled")
    channel_sms = Column(Boolean, default=False, nullable=False, comment="SMS notification enabled")
    channel_email = Column(Boolean, default=False, nullable=False, comment="Email notification enabled")
