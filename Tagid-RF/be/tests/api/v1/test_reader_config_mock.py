...
class TestReaderConfigEndpointsMock:
    ...
    def test_list_readers(self):
        ...
        mock_db = MagicMock()
        readers = [
            MockModel(id="r1", name="Reader 1", ipAddress="192.168.1.10", type="UNKNOWN", status="ONLINE", storeId="store1"),
            MockModel(id="r2", name="Reader 2", ipAddress="192.168.1.11", type="BATH", status="OFFLINE", storeId="store1")
        ]
    ...
    def test_get_reader_details(self):
        ...
        mock_db = MagicMock()
        reader = MockModel(id="r1", name="Reader 1", ipAddress="1.1.1.1", type="GATE", status="ONLINE")
