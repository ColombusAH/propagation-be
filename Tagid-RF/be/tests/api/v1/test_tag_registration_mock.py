...
class TestTagRegistrationEndpointsMock:
    ...
    def test_register_tag_new(self, mock_uuid, mock_gen_data, mock_gen_qr):
        ...
        new_tag = MockModel(id="new-uuid", epc="E123", status="UNREGISTERED", encryptedQr="RFID:HASH")
    ...
    def test_register_tag_existing(self, mock_gen_qr):
        ...
        mock_db = MagicMock()
        existing_tag = MockModel(id="t1", epc="E123", status="UNREGISTERED", encryptedQr="RFID:EXISTING")
    ...
    def test_create_product(self):
        ...
        mock_db = MagicMock()
        product = MockModel(id="p1", name="Prod 1", price=10.0, storeId="s1", sku="SKU1", category="Cat")
    ...
    def test_link_tag_to_product(self, mock_gen_qr):
        ...
        updated_tag = MockModel(
            id="t1", epc="E1", status="REGISTERED", encryptedQr="QR",
            productId="p1", productDescription="Prod 1", isPaid=False
        )
    ...
    def test_get_tag_details(self, mock_gen_qr):
        ...
        mock_db = MagicMock()
        tag = MockModel(id="t1", epc="E1", status="REGISTERED", encryptedQr="QR", productId="p1", isPaid=True)
