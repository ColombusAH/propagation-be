...
class TestTagListenerServiceMocked:
    ...
    async def test_start_stop(self, service):
        ...
        with patch('app.services.tag_listener_service.threading.Thread') as mock_thread_cls, \
    ...
    async def test_broadcast_tag_logic(self, service):
        ...
        with patch('app.services.tag_listener_service.manager', new_callable=AsyncMock) as mock_manager, \
